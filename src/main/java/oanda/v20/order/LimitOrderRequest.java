...
public class LimitOrderRequest implements OrderRequest {
     ...
     * Copy constructor
     * <p>
     * @param other the LimitOrderRequest to copy
     */
    public LimitOrderRequest(LimitOrderRequest other) {
     ...
     * @see OrderType
     */
    public LimitOrderRequest setType(OrderType type) {
        this.type = type;
        return this;
    }
     ...
     * @see InstrumentName
     */
    public LimitOrderRequest setInstrument(InstrumentName instrument) {
     ...
     * @see DecimalNumber
     */
    public LimitOrderRequest setUnits(DecimalNumber units) {
        this.units = units;
        return this;
    }
    /**
     ...
     * @see DecimalNumber
     */
    public LimitOrderRequest setUnits(String units) {
     ...
     * @see DecimalNumber
     */
    public LimitOrderRequest setUnits(BigDecimal units) {
        this.units = new DecimalNumber(units);
        return this;
    }
     ...
     * @see PriceValue
     */
    public LimitOrderRequest setPrice(PriceValue price) {
        this.price = price;
        return this;
    }
    /**
     ...
     * @see PriceValue
     */
    public LimitOrderRequest setPrice(String price) {
     ...
     * @see PriceValue
     */
    public LimitOrderRequest setPrice(BigDecimal price) {
        this.price = new PriceValue(price);
        return this;
    }
     ...
     * @see DateTime
     */
    public LimitOrderRequest setGtdTime(DateTime gtdTime) {
