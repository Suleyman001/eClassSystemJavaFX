...
public class LimitOrder implements Order {
     ...
     * Copy constructor
     * <p>
     * @param other the LimitOrder to copy
     */
     ...
     * @return {@link LimitOrder LimitOrder}
     * @see OrderID
     */
    public LimitOrder setId(OrderID id) {
        this.id = id;
        return this;
    }
    /**
     ...
     * @see OrderID
     */
    public LimitOrder setId(String id) {
     ...
     * @see DateTime
     */
    public LimitOrder setCreateTime(DateTime createTime) {
     ...
     * @see DateTime
     */
    public LimitOrder setCreateTime(String createTime) {
     ...
     * @see OrderState
     */
    public LimitOrder setState(OrderState state) {
        this.state = state;
        return this;
    }
     ...
     * @see ClientExtensions
     */
    public LimitOrder setClientExtensions(ClientExtensions clientExtensions) {
     ...
     * @see OrderType
     */
    public LimitOrder setType(OrderType type) {
        this.type = type;
        return this;
    }
     ...
     * @see InstrumentName
     */
    public LimitOrder setInstrument(InstrumentName instrument) {
     ...
     * @see InstrumentName
     */
    public LimitOrder setInstrument(String instrument) {
     ...
     * @see DecimalNumber
     */
    public LimitOrder setUnits(DecimalNumber units) {
        this.units = units;
        return this;
    }
    /**
     ...
     * @see DecimalNumber
     */
    public LimitOrder setUnits(String units) {
     ...
     * @see DecimalNumber
     */
    public LimitOrder setUnits(double units) {
        this.units = new DecimalNumber(units);
        return this;
    }
    /**
     ...
     * @see DecimalNumber
     */
    public LimitOrder setUnits(BigDecimal units) {
        this.units = new DecimalNumber(units);
        return this;
    }
     ...
     * @see PriceValue
     */
    public LimitOrder setPrice(PriceValue price) {
        this.price = price;
        return this;
    }
    /**
     ...
     * @see PriceValue
     */
    public LimitOrder setPrice(String price) {
     ...
     * @see PriceValue
     */
    public LimitOrder setPrice(BigDecimal price) {
        this.price = new PriceValue(price);
        return this;
    }
     ...
     * @see DateTime
     */
    public LimitOrder setGtdTime(DateTime gtdTime) {
     ...
     * @see DateTime
     */
    public LimitOrder setGtdTime(String gtdTime) {
     ...
     * @see OrderPositionFill
     */
    public LimitOrder setPositionFill(OrderPositionFill positionFill) {
     ...
     * @see OrderTriggerCondition
     */
    public LimitOrder setTriggerCondition(OrderTriggerCondition triggerCondition) {
     ...
     * @see TakeProfitDetails
     */
    public LimitOrder setTakeProfitOnFill(TakeProfitDetails takeProfitOnFill) {
     ...
     * @see StopLossDetails
     */
    public LimitOrder setStopLossOnFill(StopLossDetails stopLossOnFill) {
     ...
     * @see TrailingStopLossDetails
     */
    public LimitOrder setTrailingStopLossOnFill(TrailingStopLossDetails trailingStopLossOnFill) {
     ...
     * @see ClientExtensions
     */
    public LimitOrder setTradeClientExtensions(ClientExtensions tradeClientExtensions) {
     ...
     * @see TransactionID
     */
    public LimitOrder setFillingTransactionID(TransactionID fillingTransactionID) {
     ...
     * @see TransactionID
     */
    public LimitOrder setFillingTransactionID(String fillingTransactionID) {
     ...
     * @see DateTime
     */
    public LimitOrder setFilledTime(DateTime filledTime) {
     ...
     * @see DateTime
     */
    public LimitOrder setFilledTime(String filledTime) {
     ...
     * @see TradeID
     */
    public LimitOrder setTradeOpenedID(TradeID tradeOpenedID) {
     ...
     * @see TradeID
     */
    public LimitOrder setTradeOpenedID(String tradeOpenedID) {
     ...
     * @see TradeID
     */
    public LimitOrder setTradeReducedID(TradeID tradeReducedID) {
     ...
     * @see TradeID
     */
    public LimitOrder setTradeReducedID(String tradeReducedID) {
     ...
     * @see TradeID
     */
    public LimitOrder setTradeClosedIDs(Collection<?> tradeClosedIDs) {
     ...
     * @see TransactionID
     */
    public LimitOrder setCancellingTransactionID(TransactionID cancellingTransactionID) {
     ...
     * @see TransactionID
     */
    public LimitOrder setCancellingTransactionID(String cancellingTransactionID) {
     ...
     * @see DateTime
     */
    public LimitOrder setCancelledTime(DateTime cancelledTime) {
     ...
     * @see DateTime
     */
    public LimitOrder setCancelledTime(String cancelledTime) {
     ...
     * @see OrderID
     */
    public LimitOrder setReplacesOrderID(OrderID replacesOrderID) {
     ...
     * @see OrderID
     */
    public LimitOrder setReplacesOrderID(String replacesOrderID) {
     ...
     * @see OrderID
     */
    public LimitOrder setReplacedByOrderID(OrderID replacedByOrderID) {
     ...
     * @see OrderID
     */
    public LimitOrder setReplacedByOrderID(String replacedByOrderID) {
