...
public class OrderClientExtensionsModifyRejectTransaction implements Transaction {
     ...
     * Copy constructor
     * <p>
     * @param other the OrderClientExtensionsModifyRejectTransaction to copy
     */
    public OrderClientExtensionsModifyRejectTransaction(OrderClientExtensionsModifyRejectTransaction other) {
        this.id = other.id;
     ...
     * @see TransactionID
     */
    public OrderClientExtensionsModifyRejectTransaction setId(TransactionID id) {
        this.id = id;
        return this;
    }
    /**
     ...
     * @see DateTime
     */
    public OrderClientExtensionsModifyRejectTransaction setTime(DateTime time) {
        this.time = time;
        return this;
    }
    /**
     ...
     * OrderClientExtensionsModifyRejectTransaction}
     */
    public OrderClientExtensionsModifyRejectTransaction setUserID(Long userID) {
        this.userID = userID;
        return this;
    }
     ...
     * @see AccountID
     */
    public OrderClientExtensionsModifyRejectTransaction setAccountID(AccountID accountID) {
     ...
     * @see TransactionID
     */
    public OrderClientExtensionsModifyRejectTransaction setBatchID(TransactionID batchID) {
     ...
     * @see RequestID
     */
    public OrderClientExtensionsModifyRejectTransaction setRequestID(RequestID requestID) {
     ...
     * @see TransactionType
     */
    public OrderClientExtensionsModifyRejectTransaction setType(TransactionType type) {
        this.type = type;
        return this;
    }
     ...
     * @see OrderID
     */
    public OrderClientExtensionsModifyRejectTransaction setOrderID(OrderID orderID) {
     ...
     * @see ClientID
     */
    public OrderClientExtensionsModifyRejectTransaction setClientOrderID(ClientID clientOrderID) {
