...
public class CloseTransaction implements Transaction {
     ...
     * Copy constructor
     * <p>
     * @param other the CloseTransaction to copy
     */
    public CloseTransaction(CloseTransaction other) {
        this.id = other.id;
     ...
     * @see TransactionID
     */
    public CloseTransaction setId(TransactionID id) {
        this.id = id;
        return this;
    }
    /**
     ...
     * @see TransactionID
     */
    public CloseTransaction setId(String id) {
     ...
     * @see DateTime
     */
    public CloseTransaction setTime(DateTime time) {
        this.time = time;
        return this;
    }
    /**
     ...
     * @see DateTime
     */
    public CloseTransaction setTime(String time) {
     ...
     * @see AccountID
     */
    public CloseTransaction setAccountID(String accountID) {
     ...
     * @see TransactionID
     */
    public CloseTransaction setBatchID(TransactionID batchID) {
     ...
     * @see TransactionID
     */
    public CloseTransaction setBatchID(String batchID) {
     ...
     * @see RequestID
     */
    public CloseTransaction setRequestID(String requestID) {
        this.requestID = new RequestID(requestID);
        return this;
    }

    @SerializedName("type") private TransactionType type = TransactionType.CLOSE;
     ...
     * @see TransactionType
     */
    public CloseTransaction setType(TransactionType type) {
        this.type = type;
        return this;
    }
