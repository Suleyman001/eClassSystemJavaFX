...
public class MarginCallEnterTransaction implements Transaction {
     ...
     * Copy constructor
     * <p>
     * @param other the MarginCallEnterTransaction to copy
     */
    public MarginCallEnterTransaction(MarginCallEnterTransaction other) {
        this.id = other.id;
     ...
     * @see TransactionID
     */
    public MarginCallEnterTransaction setId(TransactionID id) {
        this.id = id;
        return this;
    }
    /**
     ...
     * @see DateTime
     */
    public MarginCallEnterTransaction setTime(DateTime time) {
        this.time = time;
        return this;
    }
    /**
     ...
     * @return {@link MarginCallEnterTransaction MarginCallEnterTransaction}
     */
    public MarginCallEnterTransaction setUserID(Long userID) {
        this.userID = userID;
        return this;
    }
     ...
     * @see AccountID
     */
    public MarginCallEnterTransaction setAccountID(AccountID accountID) {
     ...
     * @see TransactionID
     */
    public MarginCallEnterTransaction setBatchID(TransactionID batchID) {
     ...
     * @see RequestID
     */
    public MarginCallEnterTransaction setRequestID(RequestID requestID) {
     ...
     * @see TransactionType
     */
    public MarginCallEnterTransaction setType(TransactionType type) {
        this.type = type;
        return this;
    }
