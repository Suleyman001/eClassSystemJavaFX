...
public class MarginCallExitTransaction implements Transaction {
     ...
     * Copy constructor
     * <p>
     * @param other the MarginCallExitTransaction to copy
     */
    public MarginCallExitTransaction(MarginCallExitTransaction other) {
        this.id = other.id;
     ...
     * @see TransactionID
     */
    public MarginCallExitTransaction setId(TransactionID id) {
        this.id = id;
        return this;
    }
    /**
     ...
     * @see TransactionID
     */
    public MarginCallExitTransaction setId(String id) {
     ...
     * @see DateTime
     */
    public MarginCallExitTransaction setTime(DateTime time) {
        this.time = time;
        return this;
    }
    /**
     ...
     * @see DateTime
     */
    public MarginCallExitTransaction setTime(String time) {
     ...
     * @see AccountID
     */
    public MarginCallExitTransaction setAccountID(AccountID accountID) {
     ...
     * @see AccountID
     */
    public MarginCallExitTransaction setAccountID(String accountID) {
     ...
     * @see TransactionID
     */
    public MarginCallExitTransaction setBatchID(TransactionID batchID) {
     ...
     * @see TransactionID
     */
    public MarginCallExitTransaction setBatchID(String batchID) {
     ...
     * @see RequestID
     */
    public MarginCallExitTransaction setRequestID(RequestID requestID) {
     ...
     * @see RequestID
     */
    public MarginCallExitTransaction setRequestID(String requestID) {
        this.requestID = new RequestID(requestID);
        return this;
    }

    @SerializedName("type") private TransactionType type = TransactionType.MARGIN_CALL_EXIT;
     ...
     * @see TransactionType
     */
    public MarginCallExitTransaction setType(TransactionType type) {
        this.type = type;
        return this;
    }
